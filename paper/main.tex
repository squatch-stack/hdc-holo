...
with display holography or computer-generated holograms, a collision \S8
...
gallery, 142,000 to 1,160,000 splats, without a per-scene setting; \S9
...
\S9; Yeung et al.~\cite{yeung2026cleanup}'s comparison of cleanup
...
FHRR's three-to-four-bit phases sit exactly at the knee \S7 reports. The
...
correlation that scores arrangement in \S9 is Knapp and
...
Storage is large in absolute terms, as \S7 quantifies. Determinism is
...
rather than an order of magnitude, it exists only at \S7's four-bit rate
...
\textbf{Where one vector stops describing a place.} A whole-capture
bundle at d = 8,192, blurred to a fortieth of its cube, does not
recognise places. On the twelve gallery captures --- one true
