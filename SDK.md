...
- **Facts MCP server** (facts lane, phase 3 complete): the registry
  ...
  + cite sites), and `search_kb` (same matrix search over a math-kb
  ...
  in docs/facts.md.
- **math-kb bootstrapped** (facts lane, phase 4 complete; the facts
  plan is done): squatch-stack/math-kb is live — seven topic pages
